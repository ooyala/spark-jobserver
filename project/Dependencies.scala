...
object Dependencies {
  ...
  lazy val sparkDeps = Seq(
    "org.apache.spark" %% "spark-core" % "1.2.1" % "provided" exclude(
      "io.netty", "netty-all") excludeAll(excludeQQ),
    "org.apache.spark" %% "spark-sql" % "1.2.1" % "provided" exclude(
      "io.netty", "netty-all") excludeAll(excludeQQ),
  ...
  lazy val monitoringDeps = Seq(
    ...
    // Upgrades version from 1.0.1 to 1.0.2 to support both HTTP and UDP.
